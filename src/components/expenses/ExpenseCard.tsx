  ...
  return (
    <>
        ...
        <div className="flex-1 min-w-0 pr-1">
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-slate-500 dark:text-slate-400 mt-1">
            ...
            <div className="flex items-center gap-1.5 shrink-0 flex-wrap">
              ...
              {(expense.receipt_url || expense.receipt_translated_url) && (
                <button
                  type="button"
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  title={expense.receipt_translated_url ? (t('expenses.translatedReceipt') || 'Ticket traducido') : t('expenses.receiptPhoto')}
                >
                  <Receipt className="w-3 h-3 text-emerald-600 dark:text-emerald-400" />
                  <span className="hidden sm:inline">
                    {expense.receipt_translated_url ? '🌐 Ticket' : 'Ticket'}
                  </span>
                </button>
              )}
      ...
      <ReceiptModal
        ...
        receiptTranslatedUrl={expense.receipt_translated_url || null}
        title={expense.title}
      />
