  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* HERO SCAN TICKET / HACER FOTO (Acceso principal superior para ahorrar tiempo) */}
        {!isReadOnly && !receiptUrl && (
          <div className="p-3.5 sm:p-4 rounded-2xl bg-gradient-to-br from-emerald-500/10 via-teal-500/5 to-emerald-500/10 dark:from-emerald-950/40 dark:via-slate-900/40 dark:to-emerald-950/40 border-2 border-dashed border-emerald-400/80 dark:border-emerald-700/80 shadow-xs space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-emerald-600 text-white flex items-center gap-1 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-0.5">
              {/* Botón Principal: Hacer Foto con la cámara */}
              <label className="flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white text-xs font-bold cursor-pointer transition-all shadow-sm shadow-emerald-600/20 active:scale-[0.98]">
              ...
              {/* Botón Secundario: Subir desde Galería / Archivo */}
              <label className="flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold cursor-pointer transition-all shadow-2xs active:scale-[0.98]">
