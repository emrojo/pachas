...
export const CreateUserModal: React.FC<CreateUserModalProps> = ({
  ...
  const { createLocalUser, groups, availableUsers } = usePachas();
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Crear Usuario de Prueba (Modo Local)"
      description="Crea perfiles ficticios para probar gastos, repartos y saldos en la app"
      maxWidth="md"
    >
