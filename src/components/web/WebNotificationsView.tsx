...
export interface WebNotificationsViewProps {
  onSwitchToMobile?: () => void;
}

export function WebNotificationsView({ onSwitchToMobile }: WebNotificationsViewProps = {}) {
...
export default WebNotificationsView;
