...
export interface WebGroupDetailViewProps {
  onSwitchToMobile?: () => void;
}

export function WebGroupDetailView({ onSwitchToMobile }: WebGroupDetailViewProps = {}) {
  ...
  return (
    <div className={`min-h-screen bg-slate-50 dark:bg-slate-950 ${isChatActive ? 'pb-16 md:pb-12' : 'pb-28 md:pb-12'}`}>
      <Navbar />
